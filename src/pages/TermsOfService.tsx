          ...
          <div className="bg-white/50 backdrop-blur-xl border border-white/30 rounded-2xl p-8 sm:p-10 shadow-lg space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                By accessing or using SkillHoop ("the Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of these terms, then you may not access the Service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                Output generated by our AI tools is for suggestions only. You are responsible for verifying the accuracy of any text (resumes, cover letters) before submitting them to employers. SkillHoop is not liable for errors in AI-generated content.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                The Service and its original content, features, and functionality are owned by SkillHoop and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws. You retain ownership of any content you create using our Service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                In no event shall SkillHoop, its directors, employees, partners, agents, suppliers, or affiliates be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your use of the Service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                You agree to defend, indemnify, and hold harmless SkillHoop and its licensee and licensors, and their employees, contractors, agents, officers and directors, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to attorney's fees).
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                These Terms shall be interpreted and governed by the laws of the jurisdiction in which SkillHoop operates, without regard to its conflict of law provisions.
              </p>
            </section>
