...
export default function BrandAudit() {
        ...
        <div className="bg-white/50 backdrop-blur-xl border border-white/30 shadow-lg rounded-2xl p-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-slate-600 text-white rounded-lg font-medium hover:bg-slate-700 transition-all duration-300 disabled:opacity-50"
            >
          ...
          <div className="space-y-3">
            {recommendations.slice(0, 3).map((rec) => (
              <div key={rec.id} className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                ...
                <button className="text-slate-600 text-sm mt-2 flex items-center gap-1 hover:text-slate-800">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white/50 backdrop-blur-xl border border-white/30 shadow-lg rounded-2xl p-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="px-3 py-1 bg-slate-600 hover:bg-slate-700 text-white rounded-lg text-sm disabled:opacity-50">
          ...
          <div className="space-y-3">
            {insights.slice(0, 2).map((insight) => (
              <div key={insight.id} className="bg-slate-50 rounded-lg p-3 border border-slate-200">
                ...
                <button className="text-slate-600 text-xs mt-2 hover:text-slate-800">Read More</button>
              </div>
            ))}
          </div>
        </div>
  ...
  const renderIntelligenceTab = () => (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-blue-50 via-slate-50 to-purple-50 border border-blue-200 rounded-2xl p-6 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white/60 rounded-xl p-5 border border-slate-200 text-center">
            <div className="text-xs text-slate-500 mb-1">30 Days</div>
            <div className="text-3xl font-bold text-slate-600">{Math.min(100, brandScore.overall + 8)}</div>
          </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button className="px-4 py-2 bg-slate-600 hover:bg-slate-700 text-white rounded-lg text-sm font-medium transition-colors flex items-center gap-2">
      ...
      <div className="bg-white/50 backdrop-blur-xl border border-white/30 shadow-lg rounded-2xl p-6">
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
          <div className="flex items-center gap-4 flex-wrap">
            <select className="px-4 py-2 border border-slate-300 rounded-lg bg-white text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-500">
          ...
          <div className="flex items-center gap-2 border border-slate-300 rounded-lg p-1 bg-white">
            <button
              ...
              className={`px-3 py-1 rounded text-sm transition-colors ${insightView === 'grid' ? 'bg-slate-600 text-white' : 'text-slate-600 hover:bg-slate-100'}`}
            >
              <LayoutGrid className="w-4 h-4" />
            </button>
            <button
              onClick={() => setInsightView('list')}
              className={`px-3 py-1 rounded text-sm transition-colors ${insightView === 'list' ? 'bg-slate-600 text-white' : 'text-slate-600 hover:bg-slate-100'}`}
            >
      ...
      <div className={insightView === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6' : 'space-y-4'}>
        {insights.map((insight) => (
          <div
            key={insight.id}
            className={`bg-white/50 backdrop-blur-xl border ${!insight.isRead ? 'border-slate-300' : 'border-white/30'} shadow-lg rounded-2xl p-6 transition-all hover:shadow-xl`}
          >
            ...
            <button className="text-slate-600 text-sm font-medium hover:text-slate-800 flex items-center gap-1">
          ...
          return (
            <div key={goal.id} className="bg-white/50 backdrop-blur-xl border border-white/30 shadow-lg rounded-2xl p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-slate-500 to-purple-500 flex items-center justify-center">
              ...
              <div className="mb-2">
                ...
                <div className="w-full bg-slate-200 rounded-full h-2">
                  <div
                    className="bg-gradient-to-r from-slate-500 to-purple-500 h-2 rounded-full transition-all duration-500"
