    ...
    <div className="space-y-8 animate-fade-in-up pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div className="lg:col-span-4 grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
                { label: 'Total Certifications', val: totalCerts, icon: Award, color: 'slate' },
             ...
             <div className="flex items-center gap-3 w-full md:w-auto p-1">
                ...
                <div className="relative flex-1 md:w-64 group">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#111827]/20 focus:border-[#111827] text-sm bg-slate-50 focus:bg-white transition-all"
                    />
                </div>
                ...
                <div className="relative hidden md:block">
                     <select 
                        ...
                        className="appearance-none pl-9 pr-8 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#111827]/20 cursor-pointer hover:border-slate-300 transition-colors"
                     >
                ...
                <button
                  ...
                  className="hidden md:flex bg-[#111827] hover:bg-[#1f2937] text-white px-5 py-2.5 rounded-xl font-bold text-sm items-center gap-2 transition-all duration-300 shadow-lg shadow-slate-200 hover:shadow-slate-300 hover:-translate-y-0.5"
                >
                ...
                <button
                  onClick={handleOpenAddModal}
                  className="bg-[#111827] hover:bg-[#1f2937] text-white p-2.5 rounded-xl transition-all duration-300 shadow-md md:hidden"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {filteredCertifications.map((cert) => {
              ...
              return (
                <div
                  key={cert.id}
                  className="bg-white border border-slate-200 rounded-2xl p-5 hover:shadow-xl hover:border-slate-200 transition-all duration-300 group flex flex-col h-full relative overflow-visible"
                >
                  {/* Card Header */}
                  <div className="flex items-start gap-4 mb-4 relative">
                    ...
                    <div className="flex-1 min-w-0 pt-0.5">
                      <div className="flex items-start justify-between gap-2">
                          <h3 className="font-bold text-slate-900 leading-tight truncate pr-6 group-hover:text-[#111827] transition-colors text-[15px]" title={cert.name}>
                            {cert.name}
                          </h3>
                          ...
                          <div className="relative action-menu-container">
                             <button 
                                ...
                                className={`p-1 rounded-lg hover:bg-slate-100 transition-colors ${activeMenuId === cert.id ? 'bg-slate-100 text-[#111827]' : 'text-slate-400'}`}
                             >
                             ...
                             {activeMenuId === cert.id && (
                                 <div className="absolute right-0 top-8 w-40 bg-white border border-slate-100 rounded-xl shadow-xl z-20 py-1 animate-in fade-in zoom-in-95 duration-200 origin-top-right">
                                     <button 
                                        ...
                                        className="w-full text-left px-4 py-2.5 text-xs font-bold text-slate-700 hover:bg-slate-50 hover:text-[#111827] flex items-center gap-2"
                                     >
          ...
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl animate-fade-in-up flex flex-col">
            <div className="sticky top-0 bg-white border-b border-slate-100 p-6 flex items-center justify-between z-10 rounded-t-2xl">
              <div className="flex items-center gap-3">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${isEditing ? 'bg-amber-50 text-amber-600' : 'bg-slate-50 text-[#111827]'}`}>
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl animate-fade-in-up">
            <div className="p-6 border-b border-slate-200 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center text-[#111827]">
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full p-4 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors flex items-center gap-3 group">
                  <div className="w-10 h-10 bg-slate-50 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform">
