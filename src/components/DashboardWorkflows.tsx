...
// --- View Toggle Button (Header Component) ---
...
// --- Main Workflows View Component ---

export default function DashboardWorkflows({ darkMode, onSelectWorkflow, stats }: { darkMode: boolean, onSelectWorkflow: (flow: any) => void, stats?: any }) {
    const [activeSection, setActiveSection] = useState('active');
    const [dismissedSuggestions, setDismissedSuggestions] = useState<number[]>([]);
    const exploreWorkflows = WORKFLOWS.filter(w => w.status !== 'In Progress');
    
    // Default stats if not provided
    const defaultStats = { resumeCount: 1, jobCount: 3 };
    const workflowStats = stats || defaultStats;
            ...
            <div className="min-h-[400px]">
                ...
                {activeSection === 'recommended' && (
                    <div className="space-y-4">
                        ...
                        {workflowStats.jobCount > 0 && workflowStats.jobCount < 5 && (
