...
interface PhotoIndustrialProps {
  resumeData: {
...
const PhotoIndustrial: React.FC<PhotoIndustrialProps> = ({ resumeData, settings }) => {
  ...
  return (
    <>
      <style>{`
        .resume-industrial-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-industrial-override"
        style={{
      ...
      >
        {/* Industrial Header with Metallic Accents */}
        <header style={{
          ...
          <div style={{
            ...
            {/* Photo Section with Industrial Frame */}
            <div style={{ flexShrink: 0 }}>
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 8px 24px rgba(0, 0, 0, 0.4), inset 0 0 0 2px rgba(156, 163, 175, 0.3)',
                  ...(isHovering && {
                    borderColor: '#9ca3af',
                    boxShadow: '0 12px 32px rgba(156, 163, 175, 0.6), inset 0 0 0 4px rgba(156, 163, 175, 0.5)',
                  ...
                  <>
                    ...
                    {isHovering && (
                      ...
                      >
                        ...
                        <span style={{ color: '#9ca3af' }}>Change Photo</span>
                        <button
                  ...
                  <div style={{
                    ...
                    {isHovering ? (
                      <>
                        ...
                        <span style={{ color: '#9ca3af' }}>Upload Photo</span>
                      </>
                    ) : (
                      <span>Photo</span>
                    )}
                ...
                <section style={{ marginBottom: '30px' }}>
                  ...
                  {educationSection.items.map((item, index) => (
                    <div key={item.id || index} style={{ 
                      ...
                      {item.date && (
                        <div style={{ fontSize: '0.8rem', color: '#6b7280', fontStyle: 'normal', fontWeight: 600 }}>
                          {item.date}
                        </div>
                      )}
                    </div>
...
export default PhotoIndustrial;
