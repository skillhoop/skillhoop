...
const PhotoLuxury: React.FC<PhotoLuxuryProps> = ({ resumeData, settings }) => {
  ...
  return (
    <>
      <style>{`
        .resume-luxury-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-luxury-override"
        style={{
      ...
      >
        ...
        <header style={{
          ...
          <div style={{
            ...
            {/* Photo Section with Luxury Frame */}
            <div style={{ flexShrink: 0 }}>
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 0 4px rgba(212, 175, 55, 0.2), 0 10px 30px rgba(0, 0, 0, 0.4)',
                  ...(isHovering && {
                    borderColor: '#f4d03f',
                    boxShadow: '0 0 0 8px rgba(244, 208, 63, 0.3), 0 15px 40px rgba(244, 208, 63, 0.5)',
                  ...
                  <>
                    ...
                    {isHovering && (
                      ...
                      >
                        ...
                        <span style={{ color: '#d4af37' }}>Change Photo</span>
                        <button
                  ...
                  <div style={{
                    ...
                    {isHovering ? (
                      <>
                        ...
                        <span style={{ color: '#d4af37' }}>Upload Photo</span>
                      </>
                    ) : (
                      <span>Photo</span>
                    )}
              ...
              {skillCategories.length > 0 && (
                <section style={{ marginBottom: '35px' }}>
                  ...
                  {skillCategories.map((category, catIndex) => (
                    <div key={catIndex} style={{ marginBottom: '22px' }}>
                      <span style={{
                        fontWeight: 700,
                        marginBottom: '12px',
                        display: 'block',
                  ...
                  {educationSection.items.map((item, index) => (
                    <div key={item.id || index} style={{ 
                      ...
                      {item.title && item.subtitle && (
                        <div style={{ fontSize: '0.9rem', color: '#666666', marginBottom: '6px' }}>
                          {item.title}
                        </div>
                      )}
                      {item.date && (
                        <div style={{ fontSize: '0.85rem', color: '#d4af37', fontStyle: 'normal', fontWeight: 600 }}>
                          {item.date}
                        </div>
                      )}
                    </div>
