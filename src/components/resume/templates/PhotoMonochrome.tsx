...
interface PhotoMonochromeProps {
  resumeData: {
...
const PhotoMonochrome: React.FC<PhotoMonochromeProps> = ({ resumeData, settings }) => {
  ...
  return (
    <>
      <style>{`
        .resume-monochrome-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-monochrome-override"
        style={{
      ...
      >
        {/* Monochrome Header with Black and White */}
        <header style={{
          background: '#1a1a1a',
          color: '#ffffff',
            ...
            <div style={{ flexShrink: 0 }}>
              ...
              <div
                ...
                style={{
                  ...
                  ...(isHovering && {
                    borderColor: '#ffffff',
                    boxShadow: '0 8px 20px rgba(255, 255, 255, 0.3), 0 0 0 4px rgba(255, 255, 255, 0.2)',
                ...
                <section style={{ marginBottom: '30px' }}>
                  ...
                  {educationSection.items.map((item, index) => (
                    <div key={item.id || index} style={{ 
                      ...
                      {item.date && (
                        <div style={{ fontSize: '0.8rem', color: '#666666', fontStyle: 'normal', fontWeight: 500 }}>
                          {item.date}
                        </div>
                      )}
                    </div>
...
export default PhotoMonochrome;
