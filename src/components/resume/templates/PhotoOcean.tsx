...
const PhotoOcean: React.FC<PhotoOceanProps> = ({ resumeData, settings }) => {
  ...
  const fontFamily = settings.fontFamily || "'Montserrat', 'Arial', sans-serif";
  
  return (
    <>
      <style>{`
        .resume-ocean-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-ocean-override"
        style={{
      ...
      >
        ...
        <header style={{
          ...
          <div style={{
            ...
            width: '200px',
            height: '200px',
            background: 'radial-gradient(circle, rgba(0, 188, 212, 0.2) 2px, transparent 2px)',
          ...
          <div style={{
            ...
            {/* Photo Section with Ocean Frame */}
            <div style={{ flexShrink: 0 }}>
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 8px 24px rgba(0, 188, 212, 0.3), 0 0 0 4px rgba(0, 188, 212, 0.2)',
                  ...(isHovering && {
                    borderColor: '#4dd0e1',
                    boxShadow: '0 12px 32px rgba(77, 208, 225, 0.5), 0 0 0 8px rgba(77, 208, 225, 0.3)',
                ...
                {personalInfo.profilePicture ? (
                  <>
                    ...
                    {isHovering && (
                      ...
                      >
                        <Upload size={22} color="#00bcd4" />
                        <span style={{ color: '#00bcd4' }}>Change Photo</span>
                        <button
                  ...
                  <div style={{
                    ...
                    {isHovering ? (
                      <>
                        <Upload size={28} color="#00bcd4" />
                        <span style={{ color: '#00bcd4' }}>Upload Photo</span>
                      </>
                    ) : (
                      <span>Photo</span>
                    )}
                  ...
                  {educationSection.items.map((item, index) => (
                    <div key={item.id || index} style={{ 
                      ...
                      {item.title && item.subtitle && (
                        <div style={{ fontSize: '0.9rem', color: '#0277bd', marginBottom: '6px' }}>
                          {item.title}
                        </div>
                      )}
                      {item.date && (
                        <div style={{ fontSize: '0.85rem', color: '#00bcd4', fontStyle: 'normal', fontWeight: 600 }}>
                          {item.date}
                        </div>
                      )}
                    </div>
