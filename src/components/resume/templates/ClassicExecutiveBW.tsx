...
interface ClassicExecutiveBWProps {
  resumeData: {
...
const ClassicExecutiveBW: React.FC<ClassicExecutiveBWProps> = ({ resumeData, settings }) => {
  ...
  return (
    <>
      <style>{`
        .resume-classic-executive-bw-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-classic-executive-bw-override"
        style={{
      ...
      >
        {/* Executive Header - Centered with Double Border */}
        <header style={{
          background: '#ffffff',
          ...
          {/* Contact Information - Centered in Grid */}
        ...
        <div style={{ padding: '40px 50px' }}>
            ...
            <section style={{ marginBottom: '35px' }}>
              ...
              {experienceSection.items.map((item, index) => (
                <div key={item.id || index} style={{ 
                  marginBottom: '28px',
                  padding: '20px 0',
                  borderBottom: index < experienceSection.items.length - 1 ? '1px solid #d0d0d0' : 'none',
                }}>
                  <div style={{
                    display: 'flex',
          ...
          {/* Two Column Layout for Skills, Education, Projects, etc. */}
...
export default ClassicExecutiveBW;
