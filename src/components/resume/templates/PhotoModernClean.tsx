...
interface PhotoModernCleanProps {
  resumeData: {
...
const PhotoModernClean: React.FC<PhotoModernCleanProps> = ({ resumeData, settings }) => {
  ...
  return (
    <>
      <style>{`
        .resume-modern-clean-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-modern-clean-override"
        style={{
                  ...
                  <div style={{
                    ...
                    {isHovering ? (
                      <>
                        ...
                        <span style={{ color: '#6366f1' }}>Upload Photo</span>
                      </>
                    ) : (
                      <span>Photo</span>
                    )}
                ...
                <section style={{ marginBottom: '28px' }}>
                  ...
                  {educationSection.items.map((item, index) => (
                    <div key={item.id || index} style={{ 
                      ...
                      {item.date && (
                        <div style={{ fontSize: '0.8rem', color: '#6b7280', fontStyle: 'normal', fontWeight: 500 }}>
                          {item.date}
                        </div>
                      )}
                    </div>
...
export default PhotoModernClean;
