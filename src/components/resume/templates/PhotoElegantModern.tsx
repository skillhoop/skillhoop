...
interface PhotoElegantModernProps {
  resumeData: {
...
const PhotoElegantModern: React.FC<PhotoElegantModernProps> = ({ resumeData, settings }) => {
  ...
  const fontFamily = settings.fontFamily || "'Playfair Display', 'Georgia', serif";
  
  return (
    <>
      <style>{`
        .resume-elegant-modern-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-elegant-modern-override"
        style={{
      ...
      >
        ...
        <header style={{
          ...
          <div style={{
            ...
            width: '100%',
            height: '5px',
            background: 'linear-gradient(90deg, #e8d5b7 0%, #d4a574 50%, #e8d5b7 100%)',
          }} />
          
          {/* Decorative Bottom Elegant Curve */}
          <div style={{
            position: 'absolute',
            bottom: 0,
            left: 0,
            width: '100%',
            height: '35px',
            background: 'linear-gradient(180deg, transparent 0%, rgba(232, 213, 183, 0.15) 50%, transparent 100%)',
            ...
            <div style={{ flexShrink: 0 }}>
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 8px 24px rgba(0, 0, 0, 0.4), 0 0 0 3px rgba(232, 213, 183, 0.3)',
                  ...(isHovering && {
                    borderColor: '#d4a574',
                    boxShadow: '0 12px 32px rgba(212, 165, 116, 0.6), 0 0 0 6px rgba(212, 165, 116, 0.4)',
                ...
                {personalInfo.profilePicture ? (
                  <>
                    ...
                    {isHovering && (
                      ...
                      >
                        <Upload size={22} color="#e8d5b7" />
                        <span style={{ color: '#e8d5b7' }}>Change Photo</span>
                        <button
                  ...
                  <div style={{
                    ...
                    {isHovering ? (
                      <>
                        <Upload size={28} color="#e8d5b7" />
                        <span style={{ color: '#e8d5b7' }}>Upload Photo</span>
                      </>
                    ) : (
                      <span>Photo</span>
                    )}
                ...
                <section style={{ marginBottom: '30px' }}>
                  ...
                  {educationSection.items.map((item, index) => (
                    <div key={item.id || index} style={{ 
                      ...
                      backgroundColor: '#ffffff',
                      borderRadius: '0',
                      borderLeft: '4px solid #e8d5b7',
                      borderTop: '1px solid #e8d5b7',
                      borderRight: '1px solid #e8d5b7',
                      borderBottom: '1px solid #e8d5b7',
                    }}>
                      <div style={{ fontWeight: 600, fontSize: '1rem', color: '#2c3e50', marginBottom: '6px', fontStyle: 'italic' }}>
                        {item.subtitle || item.title || ''}
                      </div>
                      {item.title && item.subtitle && (
                        <div style={{ fontSize: '0.9rem', color: '#d4a574', marginBottom: '6px', fontStyle: 'italic' }}>
                          {item.title}
                        </div>
                      )}
                      {item.date && (
                        <div style={{ fontSize: '0.85rem', color: '#d4a574', fontStyle: 'normal', fontWeight: 400 }}>
                          {item.date}
                        </div>
                      )}
                    </div>
                  ...
                  <ul style={{
                    ...
                    {languagesSection.items.map((item, index) => (
                      <li key={item.id || index} style={{
                        ...
                        <strong style={{ color: '#2c3e50', fontStyle: 'italic' }}>{item.title || ''}</strong>
