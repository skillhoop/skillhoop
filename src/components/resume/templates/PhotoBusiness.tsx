...
const PhotoBusiness: React.FC<PhotoBusinessProps> = ({ resumeData, settings }) => {
  ...
  return (
    <>
      <style>{`
        .resume-business-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-business-override"
        style={{
      ...
      >
        ...
        <header style={{
          ...
          <div style={{
            ...
            {/* Photo Section with Professional Frame */}
            <div style={{ flexShrink: 0 }}>
              ...
              <div
                ...
                style={{
                  ...
                  ...(isHovering && {
                    borderColor: '#4a90e2',
                    boxShadow: '0 6px 18px rgba(74, 144, 226, 0.5)',
                  ...
                  {educationSection.items.map((item, index) => (
                    <div key={item.id || index} style={{ 
                      ...
                      {item.title && item.subtitle && (
                        <div style={{ fontSize: '0.85rem', color: '#2c5282', marginBottom: '4px' }}>
                          {item.title}
                        </div>
                      )}
                      {item.date && (
                        <div style={{ fontSize: '0.8rem', color: '#2c5282', fontStyle: 'normal', fontWeight: 500 }}>
                          {item.date}
                        </div>
                      )}
                    </div>
