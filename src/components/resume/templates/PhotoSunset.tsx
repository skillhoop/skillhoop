...
const PhotoSunset: React.FC<PhotoSunsetProps> = ({ resumeData, settings }) => {
  ...
  const fontFamily = settings.fontFamily || "'Lato', 'Arial', sans-serif";
  
  return (
    <>
      <style>{`
        .resume-sunset-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-sunset-override"
        style={{
      ...
      >
        {/* Sunset Header with Warm Colors */}
        <header style={{
          background: 'linear-gradient(135deg, #ff6b6b 0%, #ff8e53 20%, #ffa726 40%, #ffb74d 60%, #ff8e53 80%, #ff6b6b 100%)',
          color: '#ffffff',
          padding: '50px 50px 65px',
          position: 'relative',
          overflow: 'hidden',
        }}>
          {/* Sunset Pattern Overlay */}
          <div style={{
            position: 'absolute',
            top: 0,
            right: 0,
            width: '400px',
            height: '400px',
            background: 'radial-gradient(circle at 30% 30%, rgba(255, 183, 77, 0.2) 0%, transparent 70%)',
            borderRadius: '50%',
          ...
          <div style={{
            ...
            width: '300px',
            height: '300px',
            background: 'radial-gradient(circle at 70% 70%, rgba(255, 142, 83, 0.15) 0%, transparent 70%)',
            borderRadius: '50%',
            transform: 'translate(-20%, 20%)',
          }} />
          ...
          <div style={{
            ...
            width: '100%',
            height: '6px',
            background: 'linear-gradient(90deg, #ff6b6b 0%, #ffa726 25%, #ffb74d 50%, #ffa726 75%, #ff6b6b 100%)',
          }} />
          ...
          <div style={{
            ...
            {/* Photo Section with Sunset Frame */}
            <div style={{ flexShrink: 0 }}>
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 8px 24px rgba(0, 0, 0, 0.3), 0 0 0 4px rgba(255, 183, 77, 0.3)',
                  ...(isHovering && {
                    borderColor: '#ffb74d',
                    boxShadow: '0 12px 32px rgba(255, 183, 77, 0.6), 0 0 0 8px rgba(255, 183, 77, 0.4)',
                ...
                {personalInfo.profilePicture ? (
                  <>
                    ...
                    {isHovering && (
                      ...
                      >
                        <Upload size={22} color="#ffb74d" />
                        <span style={{ color: '#ffb74d' }}>Change Photo</span>
                        <button
                  ...
                  <div style={{
                    ...
                    {isHovering ? (
                      <>
                        <Upload size={28} color="#ffb74d" />
                        <span style={{ color: '#ffb74d' }}>Upload Photo</span>
                      </>
                    ) : (
                      <span>Photo</span>
                    )}
        ...
        <div style={{ padding: '45px 50px' }}>
          ...
          {(personalInfo.summary || summarySection) && (
            <section style={{ 
              ...
              borderRadius: '10px',
              borderLeft: '6px solid #ff8e53',
              borderTop: '2px solid rgba(255, 142, 83, 0.3)',
              borderRight: '2px solid rgba(255, 142, 83, 0.3)',
              borderBottom: '2px solid rgba(255, 142, 83, 0.3)',
            }}>
              <h2 style={{
                fontSize: '1.1rem',
                  ...
                  {educationSection.items.map((item, index) => (
                    <div key={item.id || index} style={{ 
                      ...
                      {item.title && item.subtitle && (
                        <div style={{ fontSize: '0.9rem', color: '#ff8e53', marginBottom: '6px' }}>
                          {item.title}
                        </div>
                      )}
                      {item.date && (
                        <div style={{ fontSize: '0.85rem', color: '#ff8e53', fontStyle: 'normal', fontWeight: 600 }}>
                          {item.date}
                        </div>
                      )}
                    </div>
