...
interface ClassicProfessionalBWProps {
  resumeData: {
...
const ClassicProfessionalBW: React.FC<ClassicProfessionalBWProps> = ({ resumeData, settings }) => {
  ...
  return (
    <>
      <style>{`
        .resume-classic-professional-bw-override {
          background-color: #ffffff !important;
        }
        .resume-classic-professional-bw-override aside {
          background-color: #1a1a1a !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-classic-professional-bw-override"
        style={{
      ...
      >
        {/* Left Sidebar (30%) - Black Background */}
        <aside style={{
          width: '30%',
          ...
          {/* Name and Title */}
          <div style={{ marginBottom: '30px', borderBottom: '2px solid #ffffff', paddingBottom: '20px' }}>
            ...
            <div style={{ marginBottom: '30px' }}>
              ...
              {educationSection.items.map((item, index) => (
                <div key={item.id || index} style={{ 
                  ...
                  <div style={{ fontWeight: 600, fontSize: '0.8rem', color: '#ffffff', marginBottom: '4px' }}>
...
export default ClassicProfessionalBW;
