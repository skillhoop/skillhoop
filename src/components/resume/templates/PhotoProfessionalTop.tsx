...
interface PhotoProfessionalTopProps {
  resumeData: {
...
const PhotoProfessionalTop: React.FC<PhotoProfessionalTopProps> = ({ resumeData, settings }) => {
  ...
  const fontFamily = settings.fontFamily || "'Source Sans Pro', 'Arial', sans-serif";
  
  return (
    <>
      <style>{`
        .resume-professional-top-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-professional-top-override"
        style={{
      ...
      >
                ...
                <>
                  ...
                  {isHovering && (
                    ...
                    >
                      ...
                      <span style={{ color: '#3b82f6' }}>Change Photo</span>
                      <button
                ...
                <div style={{
                  ...
                  {isHovering ? (
                    <>
                      ...
                      <span style={{ color: '#3b82f6' }}>Upload Photo</span>
                    </>
                  ) : (
                    <span>Photo</span>
                  )}
        ...
        <div style={{ padding: '40px 50px' }}>
          ...
          {/* Two Column Layout for Experience/Skills and Education/Projects */}
          <div style={{ display: 'flex', gap: '40px', alignItems: 'flex-start' }}>
            ...
            {/* Right Column - Skills, Education, Languages (40%) */}
                ...
                <section style={{ marginBottom: '30px' }}>
                  ...
                  {educationSection.items.map((item, index) => (
                    <div key={item.id || index} style={{ 
                      ...
                      <div style={{ fontWeight: 600, fontSize: '0.95rem', color: '#1a1a1a', marginBottom: '6px' }}>
                        {item.subtitle || item.title || ''}
                      </div>
                      {item.title && item.subtitle && (
                        <div style={{ fontSize: '0.85rem', color: '#3b82f6', marginBottom: '6px' }}>
                          {item.title}
                        </div>
                      )}
                      {item.date && (
                        <div style={{ fontSize: '0.8rem', color: '#3b82f6', fontStyle: 'normal', fontWeight: 500 }}>
                          {item.date}
                        </div>
                      )}
                    </div>
...
export default PhotoProfessionalTop;
