...
const PhotoBold: React.FC<PhotoBoldProps> = ({ resumeData, settings }) => {
  ...
  return (
    <>
      <style>{`
        .resume-bold-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-bold-override"
        style={{
      ...
      >
        {/* Bold Header with Diagonal Accent */}
        <header style={{
                ...
                <section style={{ marginBottom: '30px' }}>
                  ...
                  {educationSection.items.map((item, index) => (
                    <div key={item.id || index} style={{ 
                      ...
                      {item.date && (
                        <div style={{ fontSize: '0.8rem', color: '#ff6b35', fontStyle: 'italic', fontWeight: 600 }}>
                          {item.date}
                        </div>
                      )}
                    </div>
                  ...
                  <ul style={{
                    ...
                    {languagesSection.items.map((item, index) => (
                      <li key={item.id || index} style={{
                        ...
                        <strong style={{ color: '#ff6b35' }}>{item.title || ''}</strong>
