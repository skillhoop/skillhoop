...
interface ClassicHeaderBarBWProps {
  resumeData: {
...
const ClassicHeaderBarBW: React.FC<ClassicHeaderBarBWProps> = ({ resumeData, settings }) => {
  ...
  return (
    <>
      <style>{`
        .resume-classic-header-bar-bw-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-classic-header-bar-bw-override"
        style={{
      ...
      >
        ...
        <div style={{ padding: '35px 50px' }}>
          ...
          <div style={{ display: 'flex', gap: '40px', alignItems: 'flex-start' }}>
            ...
            {/* Right Column - Education, Skills, Languages, Certifications (35%) */}
...
export default ClassicHeaderBarBW;
