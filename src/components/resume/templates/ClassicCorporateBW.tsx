...
interface ClassicCorporateBWProps {
  resumeData: {
...
const ClassicCorporateBW: React.FC<ClassicCorporateBWProps> = ({ resumeData, settings }) => {
  ...
  return (
    <>
      <style>{`
        .resume-classic-corporate-bw-override {
          background-color: #ffffff !important;
        }
      `}</style>
      <div
        className="resume-preview-container w-[210mm] min-h-[297mm] resume-classic-corporate-bw-override"
        style={{
      ...
      >
        {/* Corporate Header with Full-Width Top Bar */}
        <header style={{
          background: '#000000',
          color: '#ffffff',
          padding: '30px 50px',
...
export default ClassicCorporateBW;
