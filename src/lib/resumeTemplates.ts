...
export const resumeTemplates: ResumeTemplate[] = [
  ...
  // ===== MODERN TEMPLATES =====
  {
    ...
    preview: 'bg-gradient-to-br from-slate-500 to-purple-600',
    previewGradient: 'from-slate-500 to-purple-600',
    supportsPhoto: false,
    layout: 'single-column',
    accentPosition: 'top',
    styles: {
  ...
  },
  {
    ...
    preview: 'bg-gradient-to-br from-purple-500 to-slate-600 border-2 border-purple-400',
    supportsPhoto: true,
    layout: 'single-column',
    accentPosition: 'top',
    styles: {
      container: 'max-w-[210mm] mx-auto bg-white',
      header: 'bg-gradient-to-r from-purple-500 to-slate-600 text-white p-12',
      headerName: 'text-3xl font-bold text-white',
  ...
  },
  {
    ...
    preview: 'bg-gradient-to-br from-slate-500 to-purple-600 border-2 border-slate-400',
    supportsPhoto: true,
    layout: 'single-column',
    accentPosition: 'top',
    styles: {
      container: 'max-w-[210mm] mx-auto bg-white',
      header: 'bg-gradient-to-r from-slate-500 to-purple-600 text-white p-12',
      ...
      mainContent: 'p-12 flex gap-12',
      sectionTitle: 'text-base font-extrabold uppercase tracking-wider text-slate-600 border-b-4 border-slate-600 pb-2 mb-4',
      sectionContent: 'text-sm text-gray-900 leading-relaxed',
      skillsLayout: 'tags',
      accentColor: '#6366f1',
