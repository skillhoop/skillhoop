...
5. MANDATORY REQUIREMENT: You MUST include a hyperlink to ${featurePath} in the body of the article. The anchor text for the link must be exactly '${targetFeature}'. Do not just mention the tool; you must create a clickable HTML link: <a href='${featurePath}' style='color: #2563eb; text-decoration: underline;'>${targetFeature}</a>. Place this link naturally in the 'Solution' or 'Action Plan' section.
